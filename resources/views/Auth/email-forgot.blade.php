                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <a target="_blank" href="{{ $action_link }}"
                                                                        ...
                                                                        target="_blank"
                                                                        style="color: #FFF; border-color: #E30613; border-style: solid; border-width: 10px 18px; background-color: #E30613; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">Reset
                                                                        your password</a>
                                                                </td>
                                                            </tr>
                                                        </table>
