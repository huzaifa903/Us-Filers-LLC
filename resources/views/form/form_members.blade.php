                ...
                <div class="row">
                    ...
                    <div class="card p-4 col-xl-8 me-4 mb-3 mb-xl-0">
                        <div class="content-header mb-3">
                            <h5 class="mb-0 fw-bold">Please provide Members Information for TEST LLC</h5>
                            <small>Member 01</small>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md">
                                <div class="form-check custom-option custom-option-basic">
                                    <label class="form-check-label custom-option-content"
                                        ...
                                        <input name="customRadioTemp" class="form-check-input"
                                            type="radio" value="" id="customRadioTemp2" />
                                        <span class="custom-option-header">
                            ...
                            <div class="col-sm-12 mb-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value=""
                                        id="defaultCheck1" />
                                    <label class="form-check-label" for="defaultCheck1"> Test
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value=""
                                        id="defaultCheck2" checked />
                                    <label class="form-check-label" for="defaultCheck2"> Use the assigned company address provided by Bizee
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="col-11 mt-5 d-flex justify-content-between">
                        <a href="{{ url('/form-details-state') }}" class="btn btn-outline-secondary btn-prev disabled">
                            <i class="mdi mdi-arrow-left me-sm-1"></i>
                            <span class="align-middle d-sm-inline-block d-none">Previous</span>
                        </a>
                        <a href="{{ url('#') }}" class="btn btn-custom ms-5">
