      ...
      <div
       ...
       <ul class="reset-ul inline-nav flex pointer-events-auto" data-lqd-interactive-color="true">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <form method="POST" action="{{ url('/state-filing') }}">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="card p-4 col-xl-8 me-4 mb-3 mb-xl-0">
                            <div class="content-header mb-3">
                                <h5 class="mb-0 fw-bold">State Filing Time</h5>
                                <hr>
                                <p>
                                    The typical state filing time for Ohio is <strong>4 weeks</strong>. In a
                                    hurry? Ohio offers
                                    an expedited filing option as well. Select the filing time that best meets
                                    your needs.
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-md mb-md-0 mb-2">
                                    <div class="form-check custom-option custom-option-basic">
                                        <label class="form-check-label custom-option-content" for="customRadioTemp1">
                                            <input name="state_filing_type" class="form-check-input" type="radio"
                                                value="Free" id="customRadioTemp1"
                                                {{ $stateFilingType == 'Free' || !$stateFilingType ? 'checked' : '' }} />
                                            <span class="custom-option-header">
                                                <span class="h6 mb-0 fw-bold">3 weeks filing time.</span>
                                                <span class="fw-bold">Free $0</span>
                                            </span>
                                ...
                                <div class="col-md">
                                    <div class="form-check custom-option custom-option-basic">
                                        <label class="form-check-label custom-option-content" for="customRadioTemp2">
                                            <input name="state_filing_type" class="form-check-input" type="radio"
                                                value="Paid" id="customRadioTemp2"
                                                {{ $stateFilingType == 'Paid' ? 'checked' : '' }} />
                                            <span class="custom-option-header">
                                                <span class="h6 mb-0 fw-bold">2 business days filing time
                                                    (Fast)</span>
                            ...
                            <p class="mt-4">
                                *These dates are estimations based on current state turnaround times and are
                        ...
                        <div class="col-11 mt-5 d-flex justify-content-between">
                            <a href="{{ url('/contact-person-details') }}"
