      ...
      <div
       ...
       <ul class="reset-ul inline-nav flex pointer-events-auto" data-lqd-interactive-color="true">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <form method="POST" action="{{ url('/platinum-kit-invite') }}">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="card p-4 col-xl-8 me-4 mb-3 mb-xl-0">
                            <div class="content-header mb-3">
                                <h5 class="mb-0 fw-bold">Register Agent Information</h5>
                                <hr>
                                <p>
                                    Upgrade for only $149 o receive these 3 premium services <stonrg>- up tp $240 value!
                                    </stonrg>
                                </p>
                            </div>
                            <div class="row">
                        ...
                        <div class="col-11 mt-5 d-flex justify-content-between">
                            ...
                            <div>
                                <button type="submit" class="btn btn-custom ms-5">
                                    <span class="align-middle d-sm-inline-block d-none me-sm-1">GET UPGRADE &
                                        BONUS</span>
                                    <i class="mdi mdi-arrow-right"></i>
                                </button>
                                <a href="{{ url('/process-members') }}" class="btn-outline-secondary btn-prev">
                                    <span class="align-middle d-sm-inline-block d-none">No Thanks, I will Pass on this
                                        opportunity</span>
                                </a>
                            </div>
                        </div>
