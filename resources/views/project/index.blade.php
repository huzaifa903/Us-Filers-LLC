...
@section('content')
                ...
                <div class="card mb-4">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="d-grid p-3 border">
                            <form method="GET" id="myForm" action="{{ url('/project') }}" enctype="multipart/form-data"
                                ...
                                <div class="d-flex justify-content-end  p-1 py-1">
                                    ...
                                    <a href="{{ url('/project') }}" class="btn btn-danger" tabindex="0"><span><i
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive pt-0 p-3">
                <table class="datatables-basic table table-bordered">
                    <div class="col-md-8">
                        <p>Showing {{ $project->firstItem() }} to {{ $project->lastItem() }} of {{ $project->total() }}
                            entries</p>
                    </div>
                    <thead>
                        <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a class="btn btn-primary me-2 p-2-5"
                                            href="{{ url('/project/edit/' . $item->id) }}"><i class="fa fa-edit"></i> </a>
                                        <form method="post" action="{{ url('/project/delete/' . $item->id) }}">
                                            @csrf
    ...
    <script>
        function changePerPage(select) {
            ...
            window.location.href = `{{ url('project') }}?perPage=${perPage}`;
        }
    </script>
@endsection
