...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-2"><a href="{{ url('/dashboard') }}" class="text-muted fw-light">Dashboard </a><a href="{{ url('/project') }}" class="text-muted fw-light">/ Project</a><span class="color"> /</span><span class="text-heading fw-bold text-color"> Edit</span>
        </h4>
        <div class="row">
            <!-- FormValidation -->
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" id="myForm" action="{{ url('/project/edit/' . $project->id) }}"
                            ...
                            <div class="col-12">
                                <a href="{{ url('/project') }}" type="back" class="btn btn-label-secondary waves-effect">
                                    Back
                                </a>
