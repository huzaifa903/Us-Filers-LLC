     ...
     <div class="container-xxl">
         <div class="">
             <a href="{{ url('/dashboard') }}" class="app-brand-link gap-2">
                 <img src="{{ url('/Gohar Group of Companies-01.png') }}"width="130px" height="40px" {{-- <span class="app-brand-logo demo">
                 ...
                 {{-- <span class="app-brand-text demo menu-text">Patel Dental Clinic</span> --}}
                                     ...
                                     <div class="d-flex gap-2">
                                         <div class="flex-shrink-0">
                                             <div class="avatar me-1">
                                                 <img src="profile.png" alt class="w-px-40 h-auto rounded-circle" />
                                             </div>
                                         </div>
                     ...
                     <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                         ...
                         <div class="avatar avatar-online">
                             @if (auth()->user()->profile_pic)
                                 <img src="{{ url('/uploads' . '/' . auth()->user()->profile_pic) }}" alt
                     ...
                     <ul class="dropdown-menu dropdown-menu-end">
                         ...
                         <li>
                             <a class="dropdown-item" href="{{ url('/logout') }}"
                                 ...
                                 <span class="align-middle">Log Out <form id="logout-form"
                                         action="{{ url('logout') }}" method="POST" style="display: none;">
                                         @csrf</form>
                                 </span>
                             </a>
                         </li>
