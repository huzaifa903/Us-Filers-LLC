...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-2"><a href="{{ url('/dashboard') }}" class="text-muted fw-light">Dashboard </a><a
                href="{{ url('/states') }}" class="text-muted fw-light">/ State</a><span class="color"> /</span><span
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" id="myForm" action="{{ url('/state/edit/' . $state->id) }}"
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" required class="form-control name-validate"
                                            ...
                                            value="{{ $state->name }}" aria-label="Enter Name"
                            ...
                            <div class="col-12">
                                <a href="{{ url('/state') }}" type="back" class="btn btn-label-secondary waves-effect">
                                    Back
                                </a>
